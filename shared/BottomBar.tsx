const BottomBar = () => {
  ...
  return (
    <section className="bottom-bar fixed bottom-0 z-10 w-full p-2 min-[290px]:flex md:hidden bg-[#0f172a]">
      <nav className="flex justify-between items-center gap-3">
        <p
          aria-label="home"
          className="flex justify-center items-center flex-col dark:text-[#f5f5fa]"
